...
#223.py
#3.	Напишите  функцию типа "фабрика объектов" и используйте ее для создания 
#в цикле объектов разных типов. После создания объекта 
#определите его реальный тип и выполните с ним  действия. 
